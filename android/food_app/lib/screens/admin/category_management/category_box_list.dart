...
import '../product_management/add_or_update_product.dart';
...
class CategoryBoxState extends State<CategoryBoxList> {
  ...
  Future<void> deleteCategory(Category item) async {
    final context = this.context; // Store the context before the asynchronous operation
                    ...
                    try {
                      if (value == 3) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) =>  AddOrUpdateCategorytPage(category: item),
                          ),
                        );
                      }
                    } catch (error) {
